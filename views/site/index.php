...
<!--                <p>Мы предлагаем</p>-->
    ...
    <div class="row">
        <div class="col-sm-6 col-md-4">
            <div class="single_service show-fanny wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
        ...
        <div class="col-sm-6 col-md-4">
            <div class="single_service show-fanny wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                ...
                <div class="single_service_text">
                    ...
                    <div class="service-box-price">от 500 руб</div><div class="service-box-text"><p>Поддержка рабочих мест и пользователей</p></div>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-4">
        ...
        <div class="col-sm-6 col-md-4">
            <div class="single_service show-fanny wow fadeInUp little_block" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                <div class="single_service_icon">
